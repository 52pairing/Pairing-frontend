...
export default function FreelancerSocialSignupPaymentPage() {
      ...
      <main className="mx-auto max-w-[560px] px-5 py-12">
        ...
        <section className="mt-8 rounded-lg border border-gray-200 bg-white px-8 py-9 shadow-sm">
          ...
          <SignupStepNavigation
            onPrevious={() => router.push("/signup/freelancer/social")}
            onNext={() => router.push("/signup/freelancer/social/terms")}
