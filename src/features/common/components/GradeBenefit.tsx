  ...
  return (
    <main className="min-h-screen bg-surface-subtle text-theme-primary">
      <div className="mx-auto w-full max-w-[960px] px-4 py-10">
        ...
        <h1 className="mt-3 text-2xl font-extrabold tracking-tight text-theme-primary">
          등급 혜택 안내
        </h1>
        <p className="mt-2 text-sm text-theme-secondary">
          프리랜서와 클라이언트는 활동 실적에 따라 등급이 자동으로 산정되며,
          등급이 높을수록 더 많은 혜택을 받을 수 있습니다.
        </p>
        ...
        <div className="mt-6 flex items-start gap-2 rounded-lg bg-[#edf5fb] px-4 py-3">
          ...
          <p className="text-xs leading-relaxed text-theme-secondary">
            계약 금액이 1억 원 이상이면 클라이언트 수수료가 추가로 인하됩니다.
            등급은 매월 자동으로 산정되며, 자세한 조건은 로그인 후 확인할 수
            있습니다.
          </p>
        </div>
      </div>
      ...
      <div className="grid items-start gap-4 px-5 py-4 sm:grid-cols-2">
        ...
        <div className="flex gap-3">
          <div className="flex-1 rounded-lg border border-theme bg-surface-subtle px-3 py-2 text-center">
            ...
            <p className="mt-1 text-base font-extrabold text-theme-primary">
              {startFee}
            </p>
          </div>
          <div className="flex-1 rounded-lg border border-theme bg-surface-subtle px-3 py-2 text-center">
