...
export function GuideCard({
  ...
  return (
    <section className="mt-4 overflow-hidden rounded-[11px] border border-theme bg-surface">
      <div className="bg-[#f5f6f8] px-5 py-[13px]">
        <h2 className="text-[12px] font-extrabold text-theme-primary">{title}</h2>
      </div>
...
export function GuideLine({ children }: { children: ReactNode }) {
  return (
    <div className="flex items-start gap-2 text-[11px] font-semibold leading-[1.65] text-theme-secondary">
