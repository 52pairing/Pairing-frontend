  ...
  return (
    <ClientMyPageLayout activeMenu="cancel">
      ...
      <Modal
        ...
        size="md"
        labelledBy="cancel-complete-title"
        describedBy="cancel-complete-description"
      >
        <h2 id="cancel-complete-title" className="text-[20px] font-extrabold tracking-[-0.02em]">
          탈퇴가 완료되었습니다
        </h2>
        <p id="cancel-complete-description" className="mt-4 text-[13px] font-semibold leading-6 text-theme-secondary">
  ...
  return (
    <div className="mt-6">
      ...
      {agreed ? (
        <>
          <div className="mt-7">
            <label htmlFor="cancel-reason" className="text-[12px] font-semibold text-theme-muted">
          ...
          <div className="mt-4">
            <label htmlFor="cancel-confirmation" className="text-[12px] font-semibold text-theme-muted">
