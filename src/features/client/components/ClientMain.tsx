    ...
    >
      ...
      <section className="bg-gradient-to-br from-[#183b5f] via-[#28557f] to-[#386b99]">
        <div className="mx-auto flex min-h-[316px] max-w-[744px] flex-col justify-center px-5 py-12 sm:px-8">
          <div className="mb-4 w-fit rounded-full bg-[#4678a6] px-3 py-1 text-[10px] font-bold text-white">
            골드 등급
          </div>
          ...
          <p className="mt-4 text-[11px] leading-5 text-[#c2d3e3]">
          ...
          <div className="mt-10 flex flex-wrap gap-2">
            <button
              type="button"
              className="h-[38px] rounded-lg bg-[#1d466d] px-6 text-[11px] font-bold text-white shadow-sm transition hover:bg-[#173a5b]"
            >
              프로젝트 등록하기
            </button>
